class Pessoa {
  ...
  void dormir() {
    print(
        " $nome está dormindo!"); //cria função(metodo), toda classe precisa de um método.
  }
...
void main() {
  //função principal e é obrigatória.

  Pessoa pessoa1 =
      Pessoa(); //Declarando um objeto. e é a mesma coisa que declarar uma variavél: ( String pessoa = "valor"; )
  ...
  pessoa1
      .aniversario(); //aqui ele puxou a função pra dentro da main, assim alterando o valor da idade.
  print(pessoa1.idade);
